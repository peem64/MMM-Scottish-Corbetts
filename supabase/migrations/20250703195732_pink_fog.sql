...
-- Add a note about the remaining corbetts
INSERT INTO corbetts (
  name, location, region, height, prominence, classification, estimated_time, 
  description, difficulty_rating, popular_routes, best_seasons, grid_reference, 
  nearest_town, parking_info, image_filename
...
(
  ...
  'Corbett', 
  '4-6 hours', 
  'This is a placeholder entry. The complete database would contain all 222 Scottish Corbetts with detailed information for each peak. Each corbett would have unique characteristics, routes, and seasonal information.',
  3,
  ARRAY['Various routes available', 'Multiple approach options', 'Seasonal variations'],
  ARRAY['Spring', 'Summer', 'Autumn', 'Winter'],
  'NN000000',
  'Various',
  'Parking varies by location. Check local information.',
  'placeholder-corbett.jpg'
);